<%-- 
    Document   : body
    Created on : 10 Jun, 2016, 12:07:24 AM
    Author     : Lenovo
--%>
...
<div class="container_12">
    <div class="grid_4">
      <div class="banner">
          ...
          PreparedStatement pst=con.prepareStatement("select * from news where type=?");
        ...
        <div class="maxheight">
            ...
            <marquee  behavior="scroll" direction="up" onmouseover="this.stop();" onmouseout="this.start();">
                ...
                <a href="show_news1?q=<%= rs.getString("heading") %>"><%= rs.getString("heading") %></a> <br>
     ...
     <%-- 2nd         --%> 
      ...
      <div class="banner">
          ...
          con=DbConnection.dbConnection();
           ...
           pst=con.prepareStatement("select * from news where type!=? and type!=?");
          pst.setString(1,"admin");
